...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AccompanistNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>accompanistNavigationAnimation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxMedia3LibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>media3Effect</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxSecurityCryptoLibraryAccessors extends SubDependencyFactory {
        private final AndroidxSecurityCryptoKtxLibraryAccessors laccForAndroidxSecurityCryptoKtxLibraryAccessors = new AndroidxSecurityCryptoKtxLibraryAccessors(owner);

        public AndroidxSecurityCryptoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.security.crypto.ktx</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxSecurityCryptoKtxLibraryAccessors getKtx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxSecurityCryptoKtxLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxSecurityCryptoKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxSecurityCryptoKtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v110alpha06</b> with <b>androidx.security:security-crypto-ktx</b> coordinates and
         * with version reference <b>androidxSecurityCryptoKtx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV110alpha06() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.security.crypto.ktx.v110alpha06");
        }
    ...
    public static class KoinAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v320</b> with <b>io.insert-koin:koin-android</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV320() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("koin.android.v320");
        }
    ...
    public static class KoinAndroidxComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v320</b> with <b>io.insert-koin:koin-androidx-compose</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV320() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("koin.androidx.compose.v320");
        }
    ...
    public static class KoinCoreLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v320</b> with <b>io.insert-koin:koin-core</b> coordinates and
         * with version reference <b>koinCoreVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistNavigationAnimation</b> with value <b>0.34.0</b>
         * <p>
        ...
        /**
         * Version alias <b>androidxSecurityCryptoKtx</b> with value <b>1.1.0-alpha06</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxSecurityCryptoKtx() { return getVersion("androidxSecurityCryptoKtx"); }
        ...
        /**
         * Version alias <b>foundation</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinAndroid</b> with value <b>3.1.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinAndroidVersion</b> with value <b>3.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinAndroidxCompose</b> with value <b>3.1.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinAndroidxComposeVersion</b> with value <b>3.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinAndroidxViewmodel</b> with value <b>3.1.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinCore</b> with value <b>3.1.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinCoreVersion</b> with value <b>3.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKoinCoreVersion() { return getVersion("koinCoreVersion"); }
        ...
        /**
         * Version alias <b>materialIconsCore</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>media3Effect</b> with value <b>1.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMedia3Effect() { return getVersion("media3Effect"); }
