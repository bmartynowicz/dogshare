...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AccompanistNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidxCompose</b>
         * <p>
    ...
    public static class SecurityLibraryAccessors extends SubDependencyFactory {
        private final SecurityEncryptedLibraryAccessors laccForSecurityEncryptedLibraryAccessors = new SecurityEncryptedLibraryAccessors(owner);

        public SecurityLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>security.encrypted</b>
         */
        public SecurityEncryptedLibraryAccessors getEncrypted() {
            return laccForSecurityEncryptedLibraryAccessors;
        }

    }

    public static class SecurityEncryptedLibraryAccessors extends SubDependencyFactory {

        public SecurityEncryptedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>preferences</b> with <b>androidx.security:security-crypto</b> coordinates and
         * with version reference <b>securityCrypto</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPreferences() {
            return create("security.encrypted.preferences");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxCompose</b> with value <b>1.3.0</b>
         * <p>
        ...
        /**
         * Version alias <b>androidxCore</b> with value <b>1.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxNavigation</b> with value <b>2.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
